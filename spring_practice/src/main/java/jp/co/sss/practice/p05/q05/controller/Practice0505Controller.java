...
public class Practice0505Controller {
	...
	public String complete(FruitsSeasonForm fruitsSeasonForm, Model model) {
		FruitsSeason fruitsSeason = new FruitsSeason();
		BeanUtils.copyProperties(fruitsSeasonForm, fruitsSeason);
		...
		model.addAttribute("Bean", fruitsSeasonBean);
